# Ortak Türkçe anlatım standardı — tr-narrative-v1

Bu belge günlük kart, derin günlük yorum, sohbet, dönem ve nakşatra anlatımında ortaktır. Göreve ait çıktı biçimini ve uzunluğu koru. İçeriği doğrudan Türkiye Türkçesiyle kur; İngilizce kavramları kelime kelime çevirme.
...
## Türkçe editör ölçütleri

- Kısa, tamamlanmış, açık özne ve fiil taşıyan cümleler kullan. Bir cümlede tek ana düşünceyi geliştir.
- “Öz-ifade”, “kişisel duruş alanı”, “görünürlük döneminin desteği”, “kaynaklarını toplamak” gibi etiketleri aynen sıralama; ne istediğini söylemek, görev paylaşmak, zaman ayırmak gibi bağlama uygun davranışla açıkla.
- “Enerji”, “potansiyel”, “dönüşüm”, “alan aktive oluyor” sözleri tek başına açıklama değildir. Kullanıyorsan neyi kastettiğin aynı cümlede anlaşılmalı.
- Belirsizliği astrolojik çıkarımda koru; açık önerinin her fiilini “değerlendirebilirsin” ile yumuşatma. “Olabilir” sözcüğünü bütün cümlelere dağıtma. Emir, zorunluluk veya sonuç garantisi kurma.
- “Sınır koy”, “kendine dön”, “öncelik belirle” tek başına yeterli rehberlik değildir. Hangi konuşma, talep veya davranış üzerinde çalışılabileceğini belirt; kaynağı olmayan özel bir olay ekleme.
